...
const Contact = () => {
    ...
    () => {
      ...
      mm.add("(max-width: 1023px)", () => {
        ...
        gsap.to(".p-line", {
          ...
          duration: 1.2,
          ease: "power3.out",
          scrollTrigger: { trigger: ".p-line", start: "top 85%" },
        });
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative w-full pt-[10svh] lg:pt-[15svh] pb-[5svh] px-5 lg:px-10 z-10 lg:mt-14"
    >
      <div className="w-full mx-auto flex flex-col">
        ...
        <div className="editorial-header opacity-0 w-full flex items-center justify-between mb-12 lg:mb-24 border-b border-zinc-700 pb-4">
          <span
            className={`text-[0.55rem] sm:text-[0.65rem] tracking-[0.2em] font-medium ${theme === "dark" ? "text-zinc-500" : "text-zinc-600"} uppercase`}
          >
            ( The Terminal )
          </span>
          <span
            className={`flex items-center gap-2 text-[0.55rem] sm:text-[0.65rem] tracking-[0.2em] font-medium ${theme === "dark" ? "text-zinc-500" : "text-zinc-600"} uppercase`}
          >
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <h2 className="text-[24vw] sm:text-[12vw] lg:text-[6.2rem] xl:text-[7rem] leading-[0.95em] tracking-tighter flex lg:flex-wrap">
              <span className="overflow-hidden inline-block pb-2 lg:pb-4 pr-4">
                <span className={`heading-block opacity-0 inline-block font-medium italic ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#0b0a09]"} origin-bottom-left`}>
                  Let's
                </span>
              </span>
            ...
            <p className={`p-line opacity-0 translate-y-10 ${theme === "dark" ? "text-zinc-400" : "text-zinc-600"} text-sm lg:text-base leading-relaxed mt-6 lg:mt-8 max-w-sm`}>
              Hey there. Every robust digital product begins with a single
              'hello'. I am all ears, lets create something amazing together.
            </p>
          </div>
            ...
            >
              <div className="flex items-center justify-between w-full mb-2 lg:mb-4">
                ...
                <div className="flex items-center h-6 overflow-hidden">
                  {copiedData === "email" ? (
                    <span className="text-[#FF5733] text-[0.65rem] tracking-widest uppercase font-bold animate-pulse">
                      Copied
                    </span>
                  ) : (
                    <span className={`text-zinc-600 text-[0.65rem] tracking-widest uppercase font-bold ${theme === "dark" ? "group-hover:text-[#f3f3f3]" : "group-hover:text-[#0b0a09]"} transition-colors`}>
                      Click to Copy
                    </span>
                  )}
                </div>
              ...
              <span className={`text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-light ${theme === "dark" ? "text-[#f3f3f3] lg:text-zinc-300 group-hover:text-[#f3f3f3]" : "text-[#0b0a09] lg:text-zinc-600 group-hover:text-[#0b0a09]"} transform group-hover:translate-x-2 lg:group-hover:translate-x-4 transition-all duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] pb-2 leading-normal break-all sm:break-normal`}>
                {mail}
              </span>
            </div>
            ...
            <div className="contact-item opacity-0 translate-y-10 flex flex-col border-t border-zinc-700 py-8 lg:py-10">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-8 sm:gap-12 lg:gap-16">
                ...
                <a
                  ...
                  className="group block overflow-hidden h-[32px] lg:h-[40px] w-fit"
                >
                  <div className="flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:-translate-y-1/2">
                    <div className="flex items-center gap-2 h-[32px] lg:h-[40px]">
                      ...
                      <span className={`text-2xl lg:text-4xl font-light ${theme === "dark" ? "text-[#f3f3f3] lg:text-zinc-400" : "text-[#0b0a09] lg:text-zinc-500"}`}>
                        LinkedIn
                      </span>
                      <Icon
                        icon="material-symbols:arrow-outward-rounded"
                        className={`text-xl lg:text-2xl lg:text-zinc-600 ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#0b0a09]"}`}
                      />
                    </div>
                    <div className="flex items-center gap-2 h-[32px] lg:h-[40px]">
                      <span className={`text-2xl lg:text-4xl font-light ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#0b0a09]"}`}>
                        LinkedIn
                      </span>
                      <Icon
                        icon="material-symbols:arrow-outward-rounded"
                        className="text-xl lg:text-2xl text-[#FF5733]"
                      />
                    </div>
                  </div>
                </a>
                ...
                >
                  <div className="flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:-translate-y-1/2">
                    <div className="flex items-center gap-2 h-[32px] lg:h-[40px]">
                      ...
                      <Icon
                        icon="material-symbols:arrow-outward-rounded"
                        className={`text-xl lg:text-2xl ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#0b0a09] lg:text-zinc-600"} lg:text-zinc-600`}
                      />
                    </div>
                    <div className="flex items-center gap-2 h-[32px] lg:h-[40px]">
                      <span className={`text-2xl lg:text-4xl font-light text-xl lg:text-2xl ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#0b0a09]"}`}>
                        GitHub
                      </span>
                      <Icon
                        icon="material-symbols:arrow-outward-rounded"
        ...
        <div className="footer-fade opacity-0 translate-y-10 w-full flex flex-col sm:flex-row items-center justify-between mt-20 lg:mt-24 pt-8 gap-6 sm:gap-0">
          <div className={`flex items-center gap-2 ${theme === "dark" ? "text-zinc-500" : "text-zinc-700"}`}>
            <Icon
