...
const Lab = () => {
  ...
  useGSAP(() => {
    ...
    tl.fromTo(".heading-block",
      ...
      { y: 0, skewY: 0, filter: "blur(0px)", opacity: 1, duration: 1.4, stagger: 0.15, ease: "expo.out", force3D: true },
      "-=0.8"
    );
  ...
  return (
    <section ref={sectionRef} id="lab" className="relative w-full pt-[10svh] lg:pt-[15svh] pb-[15svh] px-5 lg:px-10 lg:mt-14">
      ...
      <div className="w-full mx-auto flex flex-col relative">
        <div className="editorial-header w-full flex items-center justify-between mb-12 lg:mb-24 border-b border-zinc-700 pb-4 relative z-20">
          <span className="text-[0.55rem] sm:text-[0.65rem] tracking-[0.2em] font-medium text-zinc-500 uppercase">( R & D )</span>
          <span className="text-[0.55rem] sm:text-[0.65rem] tracking-[0.2em] font-medium text-zinc-500 uppercase">( The Lab )</span>
        </div>
